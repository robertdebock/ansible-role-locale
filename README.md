...
[![Build Status](https://travis-ci.org/robertdebock/ansible-role-locale.svg?branch=master)](https://travis-ci.org/robertdebock/ansible-role-locale)
...
# To update packages this role places on the system, set `locale_package_state` to `latest`.
